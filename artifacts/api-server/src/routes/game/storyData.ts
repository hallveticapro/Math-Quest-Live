...
export const GENRE_PROFILES = expandGenreProfiles(BASE_GENRE_PROFILES, GENRE_PROFILE_EXPANSIONS);

export const QUEST_GENRES = Object.keys(GENRE_PROFILES) as QuestGenre[];
